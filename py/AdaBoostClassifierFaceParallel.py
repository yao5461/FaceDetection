...
class AdaBoostFace:
    ...
    def traing_one_weak_classifier_slider(self, start_index, end_index):
        """
    ...
    def training_one_weak_classifier_parallel(self):
        ...
        for index in range(all_len):
            if index % 16000 == 0 and index != 0:
                jobs.append(job_server.submit(self.traing_one_weak_classifier_slider,
